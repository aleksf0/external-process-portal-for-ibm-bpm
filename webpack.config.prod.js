...
export default {
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({ // Tells React to build in prod mode. https://facebook.github.io/react/downloads.html
      'process.env.NODE_ENV': JSON.stringify('production'),
      __DEV__: false
    }),
    new ExtractTextPlugin('[name].[contenthash].css'), // Generate an external css file with a hash in the filename
    new HtmlWebpackPlugin({ // Generate HTML file that contains references to generated bundles. See here for how this works: https://github.com/ampedandwired/html-webpack-plugin#basic-usage
